...
public class MovieHandler {
  ...
  public MovieHandler(Scanner input) {
    ...
    this.movies = new Movie[MOVIE_SIZE]; // 위 배열의 레퍼런스 주소를 생성(????)
  }
  ...
  public void addMovie() {
    ...
    System.out.print("장르? ");
    movie.genre = input.nextLine();

    System.out.print("주연? ");
    movie.star = input.nextLine();

    System.out.println("평점? ");
    movie.myRating = input.nextFloat();
